...
namespace ECLEXIA.Controllers
{
    public class PermissionController : Controller
    {
        ...
        public PermissionController(XContext xContext, UserManager<User> userManager, RoleManager<AppRole> roleManager, SignInManager<User> signinmanager, IWebHostEnvironment environment)
        {
            usm = userManager;
            xct = xContext;
            rol = roleManager;
